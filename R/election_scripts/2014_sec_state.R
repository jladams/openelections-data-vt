...
# Write primary data
write_csv(primary, "./2014/20140826__vt__primary__secretary_of_state__precincts")

# Write general data
write_csv(general, "./2014/20141104__vt__general__secretary_of_state__precincts")